...
import { STORAGE_BUCKET_NAME } from '../constants/constants';
import useGetParamsChannelId from '../_hooks/useGetParamsChannelId';
import { useState } from 'react';
import Textarea, { type HandleKeyDownProps, type HandleSubmitProps } from './MessageSender/Textarea';
import { UtilsMenu } from './MessageSender';
import { useCreateMessage } from '@/hooks/queries/useChat';
...
const SenderModule = ({ isOpenPanel, handleOpenPanel }: SenderModuleProps) => {
  ...
  const { mutate: mutateChatMessage } = useCreateMessage(channelId);
